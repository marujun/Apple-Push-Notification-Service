...
Feedback.prototype.receive = function (data) {
	...
	console.log("Received packet of length: %d", data.length);
	...
	while (this.readBuffer.length > 6) {
		...
		console.log("Parsed device token: %s, timestamp: %d", token.toString("hex"), time);
		if (typeof this.options.feedback == 'function') {
			console.log("Calling feedback method for device");
...
Feedback.prototype.start = function () {
	...
	if (this.options.interval > 0) {
		console.log("Feedback service interval set at: %d", this.options.interval);
...
Feedback.prototype.request = function () {
	console.log("Performing feedback request");
...
Feedback.prototype.cancel = function () {
	console.log("Cancelling feedback interval");
